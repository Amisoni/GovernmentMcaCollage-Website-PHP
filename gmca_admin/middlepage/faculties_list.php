                            ...
                            <div class="ks-tabs-container ks-tabs-default ks-tabs-with-separator ks-tabs-header-default ks-tabs-primary tabs-bordered">
                                ...
                                <div class="tab-content table-responsiv">
                                    ...
                                    $i=1;  
                                     ...
                                     <tbody>
                                         <tr>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Faculties')) window.location.href='home.php?page=faculties_action&action=delete&profile=<?php echo $row['profile'] ?>&id=<?php echo $row['reg_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home.php?page=faculties_action" enctype="multipart/form-data">
