                            ...
                            <div class="ks-tabs-container ks-tabs-default ks-tabs-with-separator ks-tabs-header-default ks-tabs-primary tabs-bordered">
                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                     ...
                                     <tbody>
                                         <tr>
                                             ...
                                             <td><a style="text-decoration: none;color: black;" href ="<?php echo  'assets/img/notice/'.$row['file']; ?>"><?php echo $row['file'];?></a></td>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Result')) window.location.href='home.php?page=notice_action&file=<?php echo $row['file'] ?>&action=delete&id=<?php echo $row['n_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home.php?page=notice_action" enctype="multipart/form-data">
                                            <input type="hidden" name="action" value="insert">
                                            <div class="form-group row">
                                                <label for="default-input" class="col-sm-2 form-control-label">Notice Title</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea rows="4" cols="2" name="details" required="yes"  class="form-control" id="input01" autocomplete="off"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
      ...
      <form method="post" action="home.php?page=notice_action" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" required="yes" class="form-control" id="title" name="title" aria-describedby="emailHelp" placeholder="Notice Title">
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
