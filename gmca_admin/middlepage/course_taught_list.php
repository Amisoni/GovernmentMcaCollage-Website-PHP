                            ...
                            <div class="ks-tabs-container ks-tabs-default ks-tabs-with-separator ks-tabs-header-default ks-tabs-primary tabs-bordered">
                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                      ...
                                      <?php
                                    $i=1;  
                                        $sel="SELECT * FROM `course_taught` WHERE `reg_id`='".$row['reg_id']."'";
                                     ...
                                     <tbody>
                                         <tr>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Course Taught')) window.location.href='home2.php?page=course_taught_update_action&action=delete&id=<?php echo $row['course_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home2.php?page=course_taught_action" enctype="multipart/form-data">
                                            ...
                                            <tbody>
                                                <tr> 
                                                <td style="text-align: center;"><select class="form-control" name="course_type[]" required="yes">
                                                <option value="">..........Select Course Type............</option>
                                                <option value="UG Details">UG Details</option>
                                                <option value="PG Details">PG Details</option></select></td>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="home2.php?page=course_taught_update_action" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <select class="form-control" name="course_type" id="course_type" required="yes">
                                                <option value="">..........Select Course Type............</option>
                                                <option value="UG Details">UG Details</option>
                                                <option value="PG Details">PG Details</option></select>
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
...
$(document).ready(function(){
    ...
    $('#add').click(function(){
        i++;
        $('#dynamic_field').append('<tr id="row'+i+'"><td style="text-align: center;"><select class="form-control" name="course_type[]" required="yeas"><option value="">..........Select Course Type............</option><option value="UG Details">UG Details</option><option value="PG Details">PG Details</option></select></td><td style="text-align: center;"><textarea class="form-control" name="details[]" autocomplete="off" required="yes"></textarea></td><td style="text-align: center;"><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td><td hidden="yes"><input type="hidden" name="reg_id[]" value="<?php echo $_SESSION['reg_id']; ?>"></td></tr>');
    });
