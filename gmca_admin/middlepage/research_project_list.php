                            ...
                            <div class="ks-tabs-container ks-tabs-default ks-tabs-with-separator ks-tabs-header-default ks-tabs-primary tabs-bordered">
                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                      ...
                                      <?php
                                     $i=1;  
                                        $sel="SELECT * FROM `research_project` WHERE `reg_id`='".$row['reg_id']."'";
                                     ...
                                     <tbody>
                                         <tr>
                                             ...
                                             <td hidden><?php echo $row['research_id'];?></td>
                                             <td style="text-align: center;"><button type="button" class="btn btn-success editbtn"><i class='la la-pencil'></i></button></td>
                                             <td><button type="button" class="btn btn-danger" 
                                            onclick="if (confirm('Are you Sure Delete This Research Project')) window.location.href='home2.php?page=research_project_update_action&action=delete&id=<?php echo $row['research_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home2.php?page=research_project_action" enctype="multipart/form-data">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="home2.php?page=research_project_update_action" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="name">Research Project Details</label>
            <textarea rows="4" cols="2" name="details" required="yes"  class="form-control" id="details" autocomplete="off" placeholder="Research Project Details"></textarea>
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
