                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                     ...
                                     <tbody>
                                         <tr>
                                             <td><?php echo $i; ?></td>
                                             <td hidden><?php echo $row['b_id']; ?></td>
                                             <td><?php echo $row['name']; ?></td>
                                             <td><img style="border-color: #d3d300;" src="<?php echo 'assets/img/banner/'.$img_path ;?>" alt="" height="80" width="80"></td>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Banner')) window.location.href='home.php?page=banner_action&image=<?php echo $row['image'] ?>&action=delete&id=<?php echo $row['b_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home.php?page=banner_action" enctype="multipart/form-data">
