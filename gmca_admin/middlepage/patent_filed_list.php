                            ...
                            <div class="ks-tabs-container ks-tabs-default ks-tabs-with-separator ks-tabs-header-default ks-tabs-primary tabs-bordered">
                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                        <table id="ks-datatable" class="table table-striped table-bordered" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Sr No.</th>
                                                    <th>Patent Filed Details</th>
                                                    <th>Status</th>
                                                    <th hidden>patent_id</th>
                                                    <th>Update</th>
                                                    <th>Delete</th>
                                                </tr>
                                            </thead>
                                      <?php
                                     $i=1;  
                                        $sel="SELECT * FROM `patent_filed` WHERE `reg_id`='".$row['reg_id']."'";
                                     ...
                                     <tbody>
                                         <tr>
                                             ...
                                             <td hidden><?php echo $row['patent_id'];?></td>
                                             <td style="text-align: center;"><button type="button" class="btn btn-success editbtn"><i class='la la-pencil'></i></button></td>
                                             <td><button type="button" class="btn btn-danger" 
                                            onclick="if (confirm('Are you Sure Delete This Patent Filed')) window.location.href='home2.php?page=patent_filed_update_action&action=delete&id=<?php echo $row['patent_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home2.php?page=patent_filed_action" enctype="multipart/form-data">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="home2.php?page=patent_filed_update_action" enctype="multipart/form-data">
        <input type="hidden" class="form-control" id="patent_id" name="patent_id">
        <input type="hidden" class="form-control" name="action" value="update">
        <div class="modal-body">
          <div class="form-group">
            <label for="name">Patent Filed Details</label>
            <textarea rows="4" cols="2" name="details" required="yes"  class="form-control" id="details" autocomplete="off" placeholder="Patent Filed Details"></textarea>
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
