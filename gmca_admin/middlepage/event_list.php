                            ...
                            <div class="ks-tabs-container ks-tabs-default ks-tabs-with-separator ks-tabs-header-default ks-tabs-primary tabs-bordered">
                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                     ...
                                     <tbody>
                                         <tr>
                                             ...
                                             <td><img style="border-color: #d3d300;" src="<?php echo 'assets/img/event/'.$img_path ;?>" alt="" height="80" width="80"></td>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Event')) window.location.href='home.php?page=event_action&image=<?php echo $row['image'] ?>&action=delete&id=<?php echo $row['event_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home.php?page=event_action" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="default-input" class="col-sm-2 form-control-label">Event Details</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="fileInput" name="image" type="file" autocomplete="off" accept=".jpg,.jpeg,.png">
                                                </label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
      ...
      <form method="post" action="home.php?page=event_action" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" required="yes" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Event Name">
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label for="name">Event Details</label>
            <textarea rows="4" cols="2" name="details" class="form-control" id="details" autocomplete="off" placeholder="Event Details"></textarea>
          </div>
        </div>
          <div class="modal-body">
          <div class="form-group">
