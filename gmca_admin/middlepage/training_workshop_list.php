                            ...
                            <div class="ks-tabs-container ks-tabs-default ks-tabs-with-separator ks-tabs-header-default ks-tabs-primary tabs-bordered">
                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                      ...
                                      <?php
                                    $i=1;  
                                        $sel="SELECT * FROM `training_workshop` WHERE `reg_id`='".$row['reg_id']."'";
                                     ...
                                     <tbody>
                                         <tr>
                                             ...
                                             <td hidden><?php echo $row['training_id'];?></td>
                                             <td style="text-align: center;"><button type="button" class="btn btn-success editbtn"><i class='la la-pencil'></i></button></td>
                                             <td><button type="button" class="btn btn-danger" 
                                            onclick="if (confirm('Are you Sure Delete This Training Workshop')) window.location.href='home2.php?page=training_workshop_update_action&action=delete&id=<?php echo $row['training_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home2.php?page=training_workshop_action" enctype="multipart/form-data">
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align: center;"><textarea class="form-control" name="organizer[]" autocomplete="off" required="yes"></textarea></td>
                                                <td style="text-align: center;"><input class="form-control" type="text" name="duration[]" autocomplete="off" required="yes" placeholder="Start Year To End Year" /></td>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="home2.php?page=training_workshop_update_action" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <textarea rows="4" cols="2" name="title" required="yes"  class="form-control" id="title" autocomplete="off" placeholder="Title"></textarea>
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label for="name">Organizer</label>
            <textarea rows="4" cols="2" name="organizer" required="yes"  class="form-control" id="organizer" autocomplete="off" placeholder="Organizer"></textarea>
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label for="name">Duration</label>
            <input type="text" class="form-control" id="duration" name="duration" aria-describedby="emailHelp" placeholder="Duration">
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
