...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="home.php?page=result_action" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="rank" name="rank" aria-describedby="emailHelp" placeholder="Rank">
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
                                ...
                                <div class="tab-content table-responsiv">
                                    <div class="tab-pane active" id="tab4" role="tabpanel">
                                     ...
                                     <tbody>
                                         <tr>
                                             <td><?php echo $i; ?></td>
                                             <td hidden><?php echo $row['r_id']; ?></td>
                                             <td><?php echo $row['sem']; ?></td>
                                             <td><?php echo $row['rank']; ?></td>
                                             <td><?php echo $row['name']; ?></td>
                                             <td><a style="text-decoration: none;color: black;" href ="<?php echo  'assets/img/result/'.$row['file']; ?>"><?php echo $row['file'];?></a></td>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Result')) window.location.href='home.php?page=result_action&file=<?php echo $row['file'] ?>&action=delete&id=<?php echo $row['r_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home.php?page=result_action" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="default-input" class="col-sm-2 form-control-label">Rank</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="rank"  autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
