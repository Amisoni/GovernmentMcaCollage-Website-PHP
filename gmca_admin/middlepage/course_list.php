                                ...
                                <div class="tab-content table-responsiv">
                                    ...
                                    $i=1;  
                                     ...
                                     <tbody>
                                         <tr>
                                             <td><?php echo $i; ?></td>
                                             <td hidden><?php echo $row['c_id']; ?></td>
                                             <td><?php echo $row['name']; ?></td>
                                             <td><?php echo $row['details']; ?></td>
                                             <td><a style="text-decoration: none;color: black;" href ="<?php echo  'assets/img/course/'.$row['file']; ?>"><?php echo $row['file'];?></td>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Course')) window.location.href='home.php?page=course_action&file=<?php echo $row['file'] ?>&action=delete&id=<?php echo $row['c_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form method="post" action="home.php?page=course_action" enctype="multipart/form-data">
                                            <input type="hidden" name="action" value="insert">
                                            <div class="form-group row">
                                                <label for="default-input" class="col-sm-2 form-control-label">Course Name</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="name" required="yes"  autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="default-input" class="col-sm-2 form-control-label">Course Details</label>
                                                <div class="col-sm-10">
      ...
      <form method="post" action="home.php?page=course_action" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" required="yes" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Course Name">
          </div>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label for="name">Course Details</label>
            <textarea rows="4" cols="2" name="details" required="yes"  class="form-control" id="details" autocomplete="off" placeholder="Course Details"></textarea>
          </div>
        </div>
          <div class="modal-body">
          <div class="form-group">
