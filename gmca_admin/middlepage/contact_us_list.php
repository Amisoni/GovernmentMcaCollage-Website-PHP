                                    ...
                                    $i=1;  
                                     ...
                                     <tbody>
                                         <tr>
                                            ...
                                            onclick="if (confirm('Are you Sure Delete This Contact Us')) window.location.href='home.php?page=contact_us_action&action=delete&id=<?php echo $row['contact_id'] ?>'"><i class='la la-close'></i></button></td>
                                         </tr>
                                     <?php $i++; }?>
                                     </tbody>
                                        </table>
