            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="link-social">
                        <a class="sociallink" href="#"><i class="zmdi zmdi-facebook zmd1"></i></a>
                        <a class="sociallink" href="#"><i class="zmdi zmdi-rss zmd1"></i></a>
                        <a class="sociallink" href="#"><i class="zmdi zmdi-google-plus zmd1"></i></a>
                        <a class="sociallink" href="#"><i class="zmdi zmdi-pinterest zmd1"></i></a>
                        <a class="sociallink"href="#"><i class="zmdi zmdi-instagram zmd1"></i></a>
                    </div>
                </div>
                <div class="col-md-7">
                    ...
                    <form id="contact-form" action="include/contact_insert.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="contact_no" placeholder="Your Contact Number">
                            </div>
                            <div class="col-md-12">
