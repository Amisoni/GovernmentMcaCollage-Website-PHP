...
(function ($) {
    jQuery.vimeo_player = {
                    ...
                    vimeo_player.player.ready().then(function () {
                        ...
                        vimeo_player.player.on("play", function (data) {
                            ...
                            if (typeof _gaq != "undefined" && eval(vimeo_player.opt.gaTrack))
                                _gaq.push(['_trackEvent', 'vimeo_player', 'Play', vimeo_player.videoID]);
                            if (typeof ga != "undefined" && eval(vimeo_player.opt.gaTrack))
                                ga('send', 'event', 'vimeo_player', 'play', vimeo_player.videoID);
        ...
        unmute: function () {
            ...
            if (vimeo_player.volumeBar && vimeo_player.volumeBar.length)
                vimeo_player.volumeBar.updateSliderVal(vimeo_player.opt.vol > .1 ? vimeo_player.opt.vol : .1);
            var controls = jQuery("#controlBar_" + vimeo_player.id);
            var muteBtn = controls.find(".vimeo_player_muteUnmute");
        ...
        buildControls: function (vimeo_player) {
            ...
            if (vimeo_player.isBackground || (eval(vimeo_player.opt.realfullscreen) && !vimeo_player.isBackground))
        ...
        fullscreen: function (real) {
            ...
            if (typeof real == "undefined")
                real = vimeo_player.opt.realfullscreen;
            real = eval(real);
            var controls = jQuery("#controlBar_" + vimeo_player.id);
...
if (!jQuery.browser) {
    ...
    if (-1 != (verOffset = nAgt.indexOf("Opera")))
        ...
        -1 != (verOffset = nAgt.indexOf("Edge")) ? (jQuery.browser.edge = !0, jQuery.browser.name = "Microsoft Edge", jQuery.browser.fullVersion =
...
(function (b) {
    b.simpleSlider = {defaults: {initialval: 0, scale: 100, orientation: "h", readonly: !1, callback: !1}, events: {start: b.browser.mobile ? "touchstart" : "mousedown", end: b.browser.mobile ? "touchend" : "mouseup", move: b.browser.mobile ? "touchmove" : "mousemove"}, init: function (c) {
            return this.each(function () {
                ...
                var e = "h" == a.opt.orientation ? "horizontal" : "vertical", e = b("<div/>").addClass("level").addClass(e);
                d.prepend(e);
                a.level = e;
